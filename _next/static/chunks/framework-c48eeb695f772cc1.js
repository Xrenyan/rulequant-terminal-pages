...
var Scheduler = __webpack_require__(9366),
  React = __webpack_require__(5235),
  ReactDOM = __webpack_require__(5739);
...
if (true) {
  module.exports = __webpack_require__(9997);
} else {}
...
if (true) {
  module.exports = __webpack_require__(2926);
} else {}
...
if (true) {
  ...
  // DevTools can report bad minification during injection.
  checkDCE();
  module.exports = __webpack_require__(7657);
} else {}
...
var React = __webpack_require__(5235);
function formatProdErrorMessage(code) {
  var url = "https://react.dev/errors/" + code;
  if (1 < arguments.length) {
    url += "?args[]=" + encodeURIComponent(arguments[1]);
