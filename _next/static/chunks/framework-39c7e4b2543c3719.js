...
if (true) {
  module.exports = __webpack_require__(6634);
} else {}
...
if (true) {
  ...
  checkDCE();
  module.exports = __webpack_require__(7518);
} else {}
...
var React = __webpack_require__(7926);
...
var Scheduler = __webpack_require__(9079),
  React = __webpack_require__(7926),
  ReactDOM = __webpack_require__(9372);
function formatProdErrorMessage(code) {
  var url = "https://react.dev/errors/" + code;
  if (1 < arguments.length) {
    url += "?args[]=" + encodeURIComponent(arguments[1]);
...
if (true) {
  ...
  // DevTools can report bad minification during injection.
  checkDCE();
  module.exports = __webpack_require__(7488);
} else {}
